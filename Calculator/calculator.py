...
expression_field = tk.Entry(main_window, justify="right", textvariable=input_text)
...
button_equals = tk.Button(main_window, text="=", height=2, width=7, command=key_equal)
button_equals.grid(row=5, column=2, sticky="nsew")
